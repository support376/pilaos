...
export function QuickIntentForm() {
  return (
    <form action={quickAction} className="space-y-2 rounded-2xl border-2 border-gray-900 bg-white p-5">
      <div className="text-xs font-bold uppercase tracking-wider text-amber-700">조건만 등록</div>
      <h3 className="text-lg font-bold">특정 매물이 없어도 됩니다.</h3>
      <p className="text-xs text-gray-600 mb-2">조건 등록하시면 우리 풀에서 매칭한 매물 5개를 카톡으로 보내드립니다.</p>
      ...
      <select name="sido" defaultValue="" className="w-full rounded-md border border-gray-300 px-3 py-2.5 text-sm focus:border-gray-900">
        <option value="">관심 시도 선택 (선택)</option>
        <optgroup label="광역시">
      ...
      <select name="timing" defaultValue="3m" className="w-full rounded-md border border-gray-300 px-3 py-2.5 text-sm focus:border-gray-900">
